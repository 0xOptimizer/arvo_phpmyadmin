...
class __TwigTemplate_71a18b40a1d14dd384e104eb9ee4a9ec extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            yield "\"";
            // line 6
            if ((( !(($context["foreign"] ?? null) === "") && ($context["value"] == ($context["foreign"] ?? null))) || (( !            // line 7
($context["foreign"] ?? null) && array_key_exists("db", $context)) && (($context["db"] ?? null) === $context["value"])))) {
    ...
    ";
        ...
        // line 14
        yield "    ";
        if (( !(($context["foreign"] ?? null) === "") &&  !($context["seen_key"] ?? null))) {
            // line 15
            yield "        <option value=\"";
...
";
    ...
    {
        return new Source("", "table/relation/relational_dropdown.twig", "/var/www/phpmyadmin/templates/table/relation/relational_dropdown.twig");
    }
}

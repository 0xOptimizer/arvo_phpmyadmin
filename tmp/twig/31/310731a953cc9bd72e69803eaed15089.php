...
class __TwigTemplate_81fde047539677239db75f283f0a9412 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Exporting a raw query");
  ...
  ";
    ...
    {
        return new Source("", "table/export/index.twig", "/var/www/phpmyadmin/templates/table/export/index.twig");
    }
}

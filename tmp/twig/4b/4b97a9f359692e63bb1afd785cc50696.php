...
class __TwigTemplate_c44e8c46d575cc9d1143e0fb24ec0f34 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/var/www/phpmyadmin/templates/preferences/header.twig");
    }
}
